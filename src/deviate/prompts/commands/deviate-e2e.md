...
- `acceptance_proof` — the end-to-end run that demonstrates the spec's AC-NN is satisfied (test name, exit code, observed output)
- `user_facing_observation` — what the user actually sees when the feature works (CLI output, UI behavior, latency)
