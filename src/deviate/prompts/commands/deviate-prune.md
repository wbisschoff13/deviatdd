...
- `smell_category` — the type of smell the prune addressed (duplicate, low-value, dead, slow, brittle)
- `signal_source` — the metric or observation that triggered the prune decision (coverage delta, complexity, duplication count)
