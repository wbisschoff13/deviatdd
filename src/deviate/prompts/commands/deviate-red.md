...
- `assumption_frozen` — the assumption the test deliberately proves false
- `interesting_failure_mode` — the surprising or instructive way the test fails (or how it failed during RED)
