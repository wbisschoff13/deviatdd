...
- `implementation_decision` — the technical choice made to satisfy the RED test (data structure, algorithm, contract shape)
- `alternative_considered` — an alternative approach that was rejected and why
