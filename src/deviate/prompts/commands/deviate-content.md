...
description: FLOW-12 synthesis — render durable content drafts (blog, x-thread, release-notes, commit-story, resume-bullet) from .deviate/content/handovers/*.yaml.
